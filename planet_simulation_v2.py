"""
Моделирование движения планет — v2.0
=====================================
Улучшения:
  ✅ Панель управления (скорость, длина следа, пауза)
  ✅ Зум колёсиком мыши + перетаскивание
  ✅ Клик по планете — показывает информацию
  ✅ Кометы с вытянутыми орбитами
  ✅ График полной энергии системы (в отдельном окне)
  ✅ Добавить случайный астероид клавишей [A]
  ✅ Сохранить 200 кадров в GIF клавишей [S]
  ✅ Пауза клавишей [Пробел]
"""
